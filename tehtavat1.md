...
Käytämme raportin lähettämisessä Codecoviin actionia [codecov-action](https://github.com/codecov/codecov-action). Kun seuraavan kerran pushaamme koodin GitHubiin, ilmestyy Codecoviin koodin testikattavuusraportti:
